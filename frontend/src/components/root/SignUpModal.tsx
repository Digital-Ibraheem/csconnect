...
import { X, Eye, EyeOff, CheckCircle, ArrowLeft, ChevronLeft, Mail } from 'lucide-react';
...
const SignUpModal: React.FC<SignUpModalProps> = ({ onClose }) => {
    ...
    const handleGoogleResponse = async (response: any) => {
        try {
            ...
            const res = await fetch("http://localhost:8080/auth/register-google", {
                method: "POST",
                headers: {
                ...
                <div className="sm:w-1/2 w-full p-8 sm:p-12 relative flex flex-col h-full sm:h-auto justify-between">
                    <div>
                        ...
                        <p className="text-sm mt-4">
                            ...
                            <u className="cursor-pointer" onClick={() => openModal('login')}>
                                Sign in
                            </u>
                        </p>
                        ...
                        {step === 1 && (
                            <div className="mt-8 flex flex-col gap-4">
                                ...
                                >
                                    ...
                                    <span className='w-full'>Sign up with Email</span>
                                </button>
                            </div>
                        )}
